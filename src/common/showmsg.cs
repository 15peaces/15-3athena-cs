...
namespace showmsg
{
    public class console
    {
        ...
        static bool _vShowMessage(e_msg_type flag, string message = "", e_color fg_color = e_color.CL_GREY, e_color bg_color = e_color.CL_BLACK)
        {
            if (message == "")
            {
            ...
            Console.ForegroundColor = (ConsoleColor)fg_color;
            ...
            Console.WriteLine();
            Console.ForegroundColor = (ConsoleColor)e_color.CL_GREY;
            Console.BackgroundColor = (ConsoleColor)e_color.CL_BLACK;
        ...
        public static bool message(string message, e_color fg_color = e_color.CL_GREY, e_color bg_color = e_color.CL_BLACK)
        {
            return _vShowMessage(e_msg_type.MSG_NONE, message, fg_color, bg_color);
        }
